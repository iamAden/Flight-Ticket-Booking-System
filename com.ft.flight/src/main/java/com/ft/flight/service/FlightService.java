...
public class FlightService {
    ...
    public List searchFlightsBySourceAndDestination(String source, String destination){
    ...
    public List<Flight> searchFlightsByDateAndSourceAndDestination(String date, String source, String destination) {
        ...
        return flightRepository.findByDateAndSourceAndDestination(parsedDate, source, destination);
    }
